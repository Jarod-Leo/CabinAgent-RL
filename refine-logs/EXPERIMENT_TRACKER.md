...
| F11-TOOLING | 1 | prepared | train-time CAR-dev strict-best selection; LoRA-only resumable checkpoint | - | 0/250 | - | - | - | local source/tests | 51 tests PASS; step0 excluded, ties keep earlier; remote pre-flight pending |
